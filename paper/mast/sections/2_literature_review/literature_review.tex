...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=32em, trim=0 5em 0 0]{/Users/takagihayata/workspace/materialize-mongodb/paper/mast/src/MvDescription.eps} %[trim=left bottom right top]
	\end{center}
	\caption{実体化ビュー}
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=32em, trim=0 5em 0 0]{/Users/takagihayata/workspace/materialize-mongodb/paper/mast/src/MvDescription2.eps} %[trim=left bottom right top]
	\end{center}
	\caption{多対多の結合}
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=30em, trim=10em 18em 10em 0em]{/Users/takagihayata/workspace/materialize-mongodb/paper/mast/src/MongoJson.eps} %[trim=left bottom right top]
	\end{center}
