...
query_array=(10100281 10100337 10100046 10100495 10100393 10100382 10100463 10100012 10100354 10100250)
curl -X POST \
...
do
  ...
  -H 'Content-Type: application/json' \
  -H 'cache-control: no-cache' \
  -d "{\"modelName\": \"Person\", \"query\":{ \"_id\": ${i}}, \"updateDocument\": {\"name\":\"卒研太郎7\"} ,\"logLevel\": 1, \"processNum\": ${j} ,\"processNumAll\": ${#query_array[*]}, \"testId\": ${testId}}"
  sleep 2
done
curl -X POST \
